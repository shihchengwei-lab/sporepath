...
set "PYTHONPATH=src"
set "SPOREPATH_EVAL_MODEL=qwen3:1.7b"
set "SPOREPATH_EVAL_OUT=eval\qwen17_eval.jsonl"
set "SPOREPATH_EVAL_REPORT=eval\qwen17_eval.md"
set "SPOREPATH_EVAL_CLEAN_OUT=eval\qwen17_eval.clean.jsonl"
set "SPOREPATH_EVAL_CLEAN_REPORT=eval\qwen17_eval.clean.md"
set "SPOREPATH_EVAL_LIMIT=35"
...
ollama show "%SPOREPATH_EVAL_MODEL%" >nul 2>nul
if errorlevel 1 (
